...
load(['ImageStatsHuman_val_50.mat']); %load information of selected images and their object instances
...
for j = 1:length(ImageStats)
    ...
    %imwrite(I,['/home/mengmi/Desktop/NewSelected2/img/img_' num2str(j) '.jpg']);
    %imwrite(binarymask,['/home/mengmi/Desktop/NewSelected2/binMask/bin_' num2str(j) '.jpg']);
