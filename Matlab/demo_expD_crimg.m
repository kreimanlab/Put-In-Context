...
for imgnum = 1: NumImg %the current image id
    ...
    for type =[3:7]
        imgorifullname = [keyframetype '/trial_' num2str(node.bin) '_' num2str(node.classlabel)  '_' num2str(node.objIDinCate) '_' num2str(type) '_blur.jpg'];
        imgbinfullname = ['Stimulus/keyframe_expA/trial_' num2str(node.bin) '_' num2str(node.classlabel)  '_' num2str(node.objIDinCate) '_screen1_binarybdbox.jpg'];
        ...
        imwrite(crimg,[keyframetype '/trial_' num2str(node.bin) '_' num2str(node.classlabel)  '_' num2str(node.objIDinCate) '_' num2str(type) '_crimg.jpg']);
