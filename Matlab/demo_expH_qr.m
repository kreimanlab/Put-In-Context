...
for imgnum = 1: NumImg %the current image id
    ...
    imgorifullnamelist = ['Stimulus/keyframe_expH/trial_' num2str(node.bin) '_' num2str(node.classlabel)  '_' num2str(node.objIDinCate) '_*.jpg' ];
    ...
    for haveimg = 1:length(imgtypelist)
        ...
        imgorifullname = ['Stimulus/keyframe_expH/trial_' num2str(node.bin) '_' num2str(node.classlabel)  '_' num2str(node.objIDinCate) '_screen2_imgtype_' num2str(type) '.jpg'];
