...
var StroopExperiment = function() {
	...
	//there will be 
	var imagenum = _.range(1,2260)
	imagenum = _.shuffle(imagenum);
	imagenum = imagenum.slice(0,100);
    ...
    { 
    	...
    	var imagename = "http://kreiman.hms.harvard.edu/mturk/mengmi/expA_GTlabel_data/trial_" + imagenum[i] + ".jpg";    	
