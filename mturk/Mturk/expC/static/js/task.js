...
var StroopExperiment = function() {
	...
	{     
	    ...
	    { 
	    	...
	    	{
	    		var imagename = "http://kreiman.hms.harvard.edu/mturk/mengmi/keyframe_expC_gif/bin" + data_binlist[ind] + "/gif_" + data_binlist[ind] + "_" + data_catelist[ind] + "_" + data_objidlist[ind] + "_" + data_typelist[ind] + ".gif";    	
	    		imagelist.push(imagename);
	    	}
