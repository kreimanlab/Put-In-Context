...
var StroopExperiment = function() {
	...
	var TOTALNUMTRIALS = 330; //3 visual bins; 110 images per bin
	...
	var SPECTIALTYPE = 5; // full context trial from expB
	var SPECTIALTYPE2 = 6; // bbox trial from expB
	...
	{     
	    ...
	    { 
	    	...
	    	else if(data_typelist[ind] == SPECTIALTYPE)
	    	{
	    		var imagename = "http://kreiman.hms.harvard.edu/mturk/mengmi/keyframe_expB_gif/bin" + data_binlist[ind] + "/gif_" + data_binlist[ind] + "_" + data_catelist[ind] + "_" + data_objidlist[ind] + "_9.gif";    	
	    		imagelist.push(imagename);
	    	}
	    	else if(data_typelist[ind] == SPECTIALTYPE2)
	    	{
	    		var imagename = "http://kreiman.hms.harvard.edu/mturk/mengmi/keyframe_expB_gif/bin" + data_binlist[ind] + "/gif_" + data_binlist[ind] + "_" + data_catelist[ind] + "_" + data_objidlist[ind] + "_3.gif";    	
	    		imagelist.push(imagename);
	    	}
	    	else
	    	{
	    		var imagename = "http://kreiman.hms.harvard.edu/mturk/mengmi/keyframe_expE_gif/bin" + data_binlist[ind] + "/gif_" + data_binlist[ind] + "_" + data_catelist[ind] + "_" + data_objidlist[ind] + "_" + data_typelist[ind] + ".gif";    	
	    		imagelist.push(imagename);
	    	}
