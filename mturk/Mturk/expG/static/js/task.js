...
var StroopExperiment = function() {
	...
	var SPECTIALTYPE = 13; //full context
	var SPECTIALTYPE2 = 14; //bbox
	...
	{     
	    ...
	    { 
	    	...
	    	{
	    		var imagename = "http://kreiman.hms.harvard.edu/mturk/mengmi/keyframe_expG_gif/bin" + data_binlist[ind] + "/gif_" + data_binlist[ind] + "_" + data_catelist[ind] + "_" + data_objidlist[ind] + "_" + data_typelist[ind] + ".gif";    	
	    		imagelist.push(imagename);
	    	}
