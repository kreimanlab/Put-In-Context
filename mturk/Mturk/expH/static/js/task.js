...
var StroopExperiment = function() {
	...
	var SPECTIALTYPE = 3; //Fullcontext
	var SPECTIALTYPE2 = 4; //bbox
	...
	{     
	    ...
	    { 
	    	...
	    	{
	    		var imagename = "http://kreiman.hms.harvard.edu/mturk/mengmi/keyframe_expD_gif/bin" + data_binlist[ind] + "/gif_" + data_binlist[ind] + "_" + data_catelist[ind] + "_" + data_objidlist[ind] + "_2.gif";    	
	    		imagelist.push(imagename);
	    	}
	    	else if(data_typelist[ind] == SPECTIALTYPE2)
	    	{
	    		var imagename = "http://kreiman.hms.harvard.edu/mturk/mengmi/keyframe_expD_gif/bin" + data_binlist[ind] + "/gif_" + data_binlist[ind] + "_" + data_catelist[ind] + "_" + data_objidlist[ind] + "_1.gif";    	
	    		imagelist.push(imagename);
	    	}
	    	else
	    	{
	    		var imagename = "http://kreiman.hms.harvard.edu/mturk/mengmi/keyframe_expH_gif/bin" + data_binlist[ind] + "/gif_" + data_binlist[ind] + "_" + data_catelist[ind] + "_" + data_objidlist[ind] + "_" + data_typelist[ind] + ".gif";    	
	    		imagelist.push(imagename);
	    	}
