...
for i = startingMturkData:length(mturkData)
    ...
    %subjects
    forbidden = {'toosmall','glitched','unsure','unknown',' don''t','no','none','idk','dontknow','bullshit','clueless','nothing','sth'};
    counter = 0;
    for f= 1:length(forbidden)
...
save(['Mat/mturk_expA_what_compiled.mat'],'mturkData');
