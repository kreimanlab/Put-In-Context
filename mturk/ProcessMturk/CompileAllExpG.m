...
for i = startingMturkData:length(mturkData)
    ...
    %subjects
    forbidden = {'unknown',' don''t','no','none','idk','dontknow','bullshit','clueless','nothing','sth','error'};
    counter = 0;
    for f= 1:length(forbidden)
    ...
    for j = 1:length(ans)
        ...
        counter = 0;
        forbidden = {'toosmall','Toosmall','glitched','unsure',' don''t','no','none','idk','dontknow','bullshit','clueless','nothing','sth','unknown','error'};
        for f= 1:length(forbidden)
