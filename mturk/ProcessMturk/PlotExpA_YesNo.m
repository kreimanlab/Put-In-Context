...
load(['Mat/mturk_expA_YesNo_compiled.mat']);
TotalNumImg = 100;
...
errorbar(xaxis,ones(1,length(xaxis))*1/2,zeros(1,length(xaxis)),'k--','LineWidth',2);
...
print(hb,['Figures/fig_expA_YesNo' printpostfix],printmode,printoption);
