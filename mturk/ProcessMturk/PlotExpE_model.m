...
posx = 2.0; %horizontal; bigger, right
posy = 0.97; %vertical; smaller, down
textstring = 'Exp(E) Model';

expname = 'expE';
TypeSplitTime = [1 2 3 4]; %same timing per row
...
xlabelstring = 'Conditions (jigsaw + matamer)';

legendstring = {'Visual angle [0.5 1]','Visual angle [1.75 2.25]','Visual angle [3.5 4.5]','Visual angle [7 9]'};

xticklabelstring =str2mat('Jigsaw 2x2', 'Jigsaw 4x4',...
    'Jigsaw 8x8','PorscillaBG','FullContext','BBox');
...
subjplot_mean(3,3) = nan;
subjplot_std(3,3) = nan;
...
set(hb,'Position',[293   727   514   352]);
printpostfix = '.eps';
