...
posx = 1.8; %horizontal; bigger, right
posy = 0.97; %vertical; smaller, down
textstring = 'Exp(H) Humans';

expname = 'expH';
TypeSplitTime = [1 2]; %same timing per row
...
xlabelstring = 'Conditions (Congruent vs non-congruent backgrounds)';
legendstring = {'[0.5 1]','[1.75 2.25]','[3.5 4.5]','[7 9]'};
xticklabelstring =str2mat('Congruent','Incongruent','FullContext','Boundbox');
...
%get(hb,'Position')
set(hb,'Position',[680   730   605   359]);
printpostfix = '.eps';
