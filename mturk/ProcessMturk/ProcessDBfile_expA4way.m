system('sqlite3 -header -csv db/expA_4way.db "select * from expA_4way;" > csv/results_expA_4way.csv');
...
% space
fid = fopen('csv/results_expA_4way.txt');
...
fclose(fid);
save('Mat/mturk_expA_4way.mat','mturkData');