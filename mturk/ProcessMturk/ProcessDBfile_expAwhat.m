system('sqlite3 -header -csv db/expA_what.db "select * from expA_what;" > csv/results_expA_what.csv');

fid = fopen('csv/results_expA_what.csv');
out = textscan(fid,'%s');
strtotal = out{1,1};
...
fclose(fid);
save('Mat/mturk_expA_what.mat','mturkData');