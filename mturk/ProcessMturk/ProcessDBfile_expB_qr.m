...
system('sqlite3 -header -csv db/expB_qr.db "select * from expB_qr;" > csv/results_expB_qr.csv');

fid = fopen('csv/results_expB_qr.csv');
out = textscan(fid,'%s');
strtotal = out{1,1};
...
fclose(fid);
save('Mat/mturk_expB_qr.mat','mturkData');