...
system('sqlite3 -header -csv db/expC_qr.db "select * from expC_qr;" > csv/results_expC_qr.csv');

fid = fopen('csv/results_expC_qr.csv');
out = textscan(fid,'%s');
strtotal = out{1,1};
...
fclose(fid);
save('Mat/mturk_expC_qr.mat','mturkData');