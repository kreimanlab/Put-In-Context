...
system('sqlite3 -header -csv db/expD_qr.db "select * from expD_qr;" > csv/results_expD_qr.csv');

fid = fopen('csv/results_expD_qr.csv');
out = textscan(fid,'%s');
strtotal = out{1,1};
...
fclose(fid);
save('Mat/mturk_expD_qr.mat','mturkData');