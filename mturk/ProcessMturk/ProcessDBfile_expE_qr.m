...
system('sqlite3 -header -csv db/expE_qr.db "select * from expE_qr;" > csv/results_expE_qr.csv');

fid = fopen('csv/results_expE_qr.csv');
out = textscan(fid,'%s');
strtotal = out{1,1};
...
fclose(fid);
save('Mat/mturk_expE_qr.mat','mturkData');