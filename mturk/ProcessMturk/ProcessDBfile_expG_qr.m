...
system('sqlite3 -header -csv db/expG_qr.db "select * from expG_qr;" > csv/results_expG_qr.csv');

fid = fopen('csv/results_expG_qr.csv');
out = textscan(fid,'%s');
strtotal = out{1,1};
...
fclose(fid);
save('Mat/mturk_expG_qr.mat','mturkData');