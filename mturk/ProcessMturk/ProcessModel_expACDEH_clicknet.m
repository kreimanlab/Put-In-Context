...
for e = 1:length(expnamelist)
    ...
    for i = 1:length(Test.TbinL)
        ...
        %load(['/home/mengmi/Projects/Proj_context2/pytorch/fovea_grid/results_' expname '_feedforward/' loadname]);
        load(['/home/mengmi/Projects/Proj_context2/pytorch/fovea_grid_lstm_1/results_' expname '/' loadname]);
...
%             %imwrite(stimuli,['/home/mengmi/Desktop/img' num2str(i) '.jpg']);
%             flag = 1;
%             if flag == 1
...
%         pause;
    ...
    save(['Mat/foveanetConvLSTM_' expname '.mat'],'mturkData');
