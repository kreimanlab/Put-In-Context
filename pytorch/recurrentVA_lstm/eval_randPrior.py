...
img_folder = '/home/mengmi/Projects/Proj_context1/Datasets/MSCOCO/mouseclick_randomPrior/'
...
#        print(imgname[0][len(img_folder):-4])
        #save results
        sio.savemat('results_RandomPrior/'+ imgname[0][len(img_folder):-4] + '.mat', {'predicted_seq':np.asarray(predicted_seq, dtype=np.int32), 'alphas': alphas.numpy(), 'clickS':clickS})
        print('Iter: [{0}/{1}]\t'
