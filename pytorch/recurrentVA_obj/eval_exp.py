...
expname = 'expA'; #expA, expC, expD, expE, expH
txt_folder = '/home/mengmi/Projects/Proj_context2/Datalist/' 
img_folder = '/home/mengmi/Projects/Proj_context2/Matlab/Stimulus/keyframe_' + expname + '/'
bin_folder = '/home/mengmi/Projects/Proj_context2/Matlab/Stimulus/keyframe_expA/'

if expname == 'expD':
    crimg_folder = '/home/mengmi/Projects/Proj_context2/Matlab/Stimulus/keyframe_expD/'
else: 
...
def evaluate():
    ...
    # For each image
    for i, (imgs, binimgs, blurs, labels, imgname, crimg) in enumerate(test_loader):
...
#        print(imgname[0][len(img_folder):-4])
        #save results
        sio.savemat('results_' + expname + '/'+ imgname[0][len(img_folder):-4] + '.mat', {'score': scores.cpu().detach().numpy(),'predicted_seq':np.asarray(predicted_seq, dtype=np.int32), 'alphas_obj': alphas_obj.numpy(), 'alphas_context': alphas_context.numpy()})
        print('Iter: [{0}/{1}]\t'
