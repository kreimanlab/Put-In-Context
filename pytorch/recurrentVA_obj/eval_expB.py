...
trialtype = 2 #choose among 1, 2, 3
if trialtype == 1:
...
#        print(imgname)
        ...
        # forward everything
        scores, alphas_obj, alphas_context, clickS = decoder.forwardExpB(encoder, transform, imgs, blurs, binimgs, click_steps, batch_size, imgsz, ClickRadius, Pmask, TSC, crimg)
#        print('scores')
#        print(scores.shape)
        #print('alphas')
        #print(alphas.shape)
